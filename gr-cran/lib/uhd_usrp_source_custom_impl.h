...
#ifndef INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_IMPL_H
#define INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_IMPL_H

#include <gnuradio/cran/uhd_usrp_source_custom.h>
 ...
 **********************************************************************/
class uhd_usrp_source_custom_impl : public uhd_usrp_source_custom, public gr::uhd::usrp_block_impl
{
public:
    uhd_usrp_source_custom_impl(const ::uhd::device_addr_t& device_addr,
                     const ::uhd::stream_args_t& stream_args,
                     const bool issue_stream_cmd_on_start = true);
    ~uhd_usrp_source_custom_impl() override;
    ...
    void set_lo_source(const std::string& src,
                       const std::string& name = gr::uhd::ALL_LOS,
...
private:
    ...
    ::uhd::time_spec_t _time_last_pps;

    // tag shadows
    double _samp_rate;
    std::chrono::time_point<std::chrono::steady_clock> _last_tag;

    std::recursive_mutex d_mutex;

    const pmt::pmt_t _direction() const override { return gr::uhd::direction_rx(); };
};
} // namespace custom_tools
} // namespace gr

#endif /* INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_IMPL_H */
