...
#ifndef INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_H
#define INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_H
 ...
 *
 */
class GR_UHD_API uhd_usrp_source_custom : virtual public gr::uhd::usrp_block
{
public:
    // gr::uhd::usrp_source::sptr
    typedef std::shared_ptr<uhd_usrp_source_custom> sptr;
...
#endif /* INCLUDED_CUSTOM_TOOLS_UHD_USRP_SOURCE_CUSTOM_H */
